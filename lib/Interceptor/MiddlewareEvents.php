...
namespace GuardianScoreSimulacion\Client\Interceptor;
...
use \GuardianScoreSimulacion\Client\Interceptor\KeyHandler;
use \GuardianScoreSimulacion\Client\Interceptor\MyLogger;
use \GuardianScoreSimulacion\Client\Model\Errors;
use \GuardianScoreSimulacion\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\GuardianScoreSimulacion\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \GuardianScoreSimulacion\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \GuardianScoreSimulacion\Client\Model\Errores(["errors" => [$error]]);
